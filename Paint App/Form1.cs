...
//  Bileşenlerin tasarımı, veri bağlama, olay yönetimi ve bileşen tabanlı mimarilerle ilgili işlemler için 
using System.ComponentModel;

// veri sorgulamalarını yapmasını, veri ekleme ve güncelleme
using System.Data;
...
namespace Signature_App
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            this.Width = 950;
            this.Height = 700;
            //genişliği 950 piksel ve yüksekliği 700 piksel olan bir boş görüntüyü bm adında bir Bitmap örneği olarak oluşturur
            bm = new Bitmap(Pic.Width, Pic.Height);
            //bm adında bir Bitmap nesnesi üzerinde çizim işlemleri gerçekleştirmek için g adında bir Graphics örneği oluşturur. 
            g = Graphics.FromImage(bm);

            //g adındaki Graphics örneği üzerindeki alanı tamamen beyaz renkle temizler.
            g.Clear(Color.White);

            // bm adında bir Bitmap örneğini Pic kontrolünün görüntüsü olarak ayarlanır
            Pic.Image = bm;
        }
        //Bitmap sınıfı, görüntü işleme, grafikler oluşturma, piksel düzeyinde işlemler yapma ve resim dosyalarıyla çalışmada kullanılır.
        Bitmap bm;
        Graphics g;
        bool paint = false;
        Point px, py;
        ...
        //ColorDialog sınıfı, renk seçimi yapmak için bir iletişim kutusu sağlar
